...
import { useAuthStore, getSavedCredentials } from '@renderer/stores/auth.store'
import { useThemeStore, useAppStore } from '@renderer/stores/app.store'
...
export default function WelcomePage() {
  ...
  const handleSignIn = async (e?: React.FormEvent) => {
    ...
    await loginAsync({ email, password, name: fullName, role: selectedRole, designation: finalDesignation, rememberMe })
  }
  ...
  const handleSignUp = async (e?: React.FormEvent) => {
    ...
    await registerAsync({ name: fullName, email, password, companyName, designation: finalDesignation, role: selectedRole })
  }
